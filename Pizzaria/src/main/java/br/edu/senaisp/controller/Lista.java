...
public class Lista extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		html.append("    background-color: #0d131e;");
		html.append("    color: white;");
		html.append("    align-items: center;");
		html.append("    padding: 10px;");
		html.append("}");
		html.append("");
		html.append(".box button {");
		html.append("    height: 30px;");
		html.append("    font-weight: 900;");
		html.append("    cursor: pointer;");
		html.append("    background: linear-gradient(#1604d8, #7079dc);");
		html.append("    color: white;");
		...
		html.append("<h1><a href=\"/Pizzaria/inicial.html\">Volte ao inicio</a></h1>");
